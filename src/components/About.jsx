    ...
    <motion.div style={{ height: "100%" }}>
      ...
      <motion.div className="flex w-full">
        <motion.p
          ...
          className="mt-4 text-secondary flex w-full md:w-2/3 text-sm md:text-base lg:text-lg leading-normal md:leading-relaxed"
        >
          ...
          delivered projects on time and met milestones.<br></br>
          <br></br>
