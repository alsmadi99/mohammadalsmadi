...
Command: npx gltfjsx@6.2.5 .\public\models\chair.glb
...
export function Chair(props) {
  ...
  return (
    <group {...props} dispose={null} position={[0, 0, 0.1]}>
      <group position={[0, 0.526, 0.045]} scale={[0.154, 0.202, 0.255]}>
        <mesh
          geometry={nodes.Object_5.geometry}
          material={materials.black_skin}
        />
        <mesh geometry={nodes.Object_6.geometry} material={materials.outline} />
      </group>
      <group
